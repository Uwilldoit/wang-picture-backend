...
import com.wang.wangpicturebackend.model.enums.SpaceRoleEnum;
...
import com.wang.wangpicturebackend.service.SpaceUserService;
import com.wang.wangpicturebackend.mapper.SpaceUserMapper;
...
public class SpaceUserServiceImpl extends ServiceImpl<SpaceUserMapper, SpaceUser>
    ...
    public void validSpaceUser(SpaceUser spaceUser, boolean add) {
        ...
        if (add) {
            ...
            //校验是否已添加该成员
            boolean exists = this.lambdaQuery().eq(SpaceUser::getSpaceId, spaceId)
                    .eq(SpaceUser::getUserId, userId).exists();
            ThrowUtils.throwIf(exists,ErrorCode.PARAMS_ERROR,"用户已在队伍中");
